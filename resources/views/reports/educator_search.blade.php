    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="report_form" method="POST" action="/reports/educators">
                    {{ csrf_field() }}
                    ...
                    <div class="box-body">
						...
						<div class="form-group">
                            <label for="start_date" class="col-sm-3 control-label">Engagement Date</label>
                            <div class="col-sm-9">
                                <div class="input-group">
								<div class="input-group-addon">
						...
						<div class="form-group ">
								<label for="module_registered" class="col-sm-3 control-label">Qualification</label>
								<div class="col-sm-9">
									<div class="input-group">
										<div class="input-group-addon">
										   <i class="fa fa-book"></i>
										</div>
										<input type="number" class="form-control" id="highest_qualification" name="highest_qualification" value="" placeholder="Qualification">
									</div>
								</div>
						</div>
                     </div>   
