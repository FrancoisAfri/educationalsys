...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <p id="box-subtitle">Report Criteria</p>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="/reports/get_attendance">
                    {{ csrf_field() }}
                    ...
                    <div class="box-body">
						...
						<div class="form-group{{ $errors->has('attendance_date') ? ' has-error' : '' }}">
                            <label for="attendance_date" class="col-sm-2 control-label">Date Range</label>
                            <div class="col-sm-10">
                                <div class="input-group">
								<div class="input-group-addon">
									<i class="fa fa-user"></i>
								</div>
								<input type="text" class="form-control daterangepicker" id="attendance_date" name="attendance_date" value="" placeholder="Select Attendance Date...">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-success pull-right"><i class="fa fa-cloud-download"></i> Load Learners</button>
                    </div>
                    <!-- /.box-footer -->
                </form>
            </div>
		...
		@if(Session('success_add'))
            @include('contacts.partials.success_action', ['modal_title' => 'Attendance Marked!', 'modal_content' => session('success_add')])
        @endif
    </div>
@endsection
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#rdo_learner, #rdo_educator, #rdo_gen_pub').on('ifChecked', function(){
                ...
                if (regType == 1) $('#box-subtitle').html('Report Criteria');
                else if (regType == 2) $('#box-subtitle').html('Report Criteria');
                else if (regType == 3) $('#box-subtitle').html('Report Criteria');
            });
