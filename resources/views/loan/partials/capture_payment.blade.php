                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="amount_paid" name="amount_paid" placeholder="Enter the amount paid" value="{{ (isset($month_instalment) && $month_instalment > 0) ? number_format($month_instalment, 2) : '' }}">
                            </div>
                        </div>
                    </div>
                </div>
