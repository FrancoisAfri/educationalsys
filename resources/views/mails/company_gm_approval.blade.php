...
<head>
    ...
    <title>{{ $company_name }} - {{ $company_type }} Needs Approval</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like to inform you that a new {{ $company_type }} has been loaded and needs your final approval.<br>
                                                    Please <a target="_blank" href="{{ url($company_url) }}">click here.</a> to login to the system and attend to it.
                                                </td>
                                            </tr>
                                            <tr>
