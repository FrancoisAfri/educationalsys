...
<head>
    ...
    <title>{{ $company_name }} - Programme Rejected</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like to inform you that the programme you loaded has been rejected for the following reason:<br><br>
                                                    <b>{{ $rejection_reason }}</b> <br><br>
                                                    Please <a target="_blank" href="{{ url($programme_url) }}">click here.</a> to login to the system and view the programme details.
                                                </td>
                                            </tr>
                                            <tr>
