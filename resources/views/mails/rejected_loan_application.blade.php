...
<head>
    ...
    <title>{{ $company_name }} - Loan Application Needs Attention</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like to inform you that your loan application has been rejected for the following reason:<br>
                                                    <b>{{ $rejection_reason }}</b> <br>
                                                    Please <a target="_blank" href="{{ $loan_url }}">click here.</a> to login to the system and attend to it.
                                                </td>
                                            </tr>
                                            <tr>
