...
<head>
    ...
    <title>{{ $company_name }} - Activity Completed</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like to inform you that there is an activity that has been completed.<br>
                                                    Please <a target="_blank" href="{{ url($activity_url) }}">click here.</a> to login to the system and see more details.
                                                </td>
                                            </tr>
                                            <tr>
