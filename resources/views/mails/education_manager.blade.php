...
<head>
    ...
    <title>{{ $company_name }} - Project Registration</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $firstname }},<br><br>
                                                    We would like to inform you that there is a new project that requires your attention please <a target="_blank" href="{{ $loan_url }}">click here.</a> to log on to the system and attend to it.
                                                </td>
                                            </tr>
                                            <tr>
