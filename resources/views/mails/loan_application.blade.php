...
<head>
    ...
    <title>{{ $company_name }} - Loan Application</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $firstname }},<br><br>
                                                    We would like to inform you that there is a new loan application that require your attention please <a target="_blank" href="{{ $loan_url }}">click here.</a> to log on to the system and attend to it.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-top:20px;background-color:#ffffff;">
                                                    Best regards,<br>
                                                    The NU-LAXMI LEASING
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
