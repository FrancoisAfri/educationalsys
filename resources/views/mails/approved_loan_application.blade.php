...
<head>
    ...
    <title>{{ $company_name }} - Approved Loan Application</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like to inform you that your application for a R{{ $loan->amount_wanted }} from {{ $company_name }} has been approved.<br>
                                                </td>
                                            </tr>
                                            <tr>
