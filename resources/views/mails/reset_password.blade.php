                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like you to know that your password has been successfully reset! Use the credentials below to login to the system. To change your password, <a target="_blank" href="{{ $profile_url }}">click here.</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
