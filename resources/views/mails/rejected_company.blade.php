...
<head>
    ...
    <title>{{ $company_name }} - {{ $company_type }} Rejected</title>
                            ...
                            <table cellpadding="0" cellspacing="0" class="force-full-width">
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like to inform you that the {{ $company_type }} you loaded has been rejected for the following reason:<br><br>
                                                    <b>{{ $rejection_reason }}</b> <br><br>
                                                    Please <a target="_blank" href="{{ url($company_url) }}">click here.</a> to login to the system and view the {{ $company_type }} details.
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    <td valign="top" class="footer-cell">
                                        <h4>{{ $company_name }}</h4>
                                        <i>Inspiring Tomorrow's Scientists</i><br>
