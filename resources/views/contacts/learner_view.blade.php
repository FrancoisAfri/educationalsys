...
@section('content')
    <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <select name="gender" class="form-control">
                                        ...
                                        <option value="2" {{ (empty($learner->gender) && $learner->gender == 2) ? ' selected': '' }}>Female</option>
                                    </select>
                                </div>
                            </div>
                        </div>
        ...
        @if(Session('success_edit'))
            @include('contacts.partials.success_action', ['modal_title' => 'Learner Details Updated!', 'modal_content' => session('success_edit')])
    ...
    <script>
        $(function () {
            ...
            $('#add-more-clt').click(function () {
                location.href = "{!! route('learnerregistration', ['project' => !empty($learner->project_id) ? $learner->project_id : -1, 'activity'=> !empty($learner->activity_id) ? $learner->activity_id : -1]) !!}";
            });
        });
