                ...
                <form class="form-horizontal" method="POST" action="/contacts">
                    ...
                    <div class="box-body">
                     ...
                     <div class="form-group{{ $errors->has('org_name') ? ' has-error' : '' }}">
                            <label for="position" class="col-sm-3 control-label">Name of Organisation</label>
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="org_name" name="org_name" value="{{ old('org_name') }}" placeholder="Name of Organisation">
                                </div>
                            </div>
                    </div>
                    <!-- /.box-body -->
