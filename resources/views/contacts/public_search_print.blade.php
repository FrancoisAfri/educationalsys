...
<head>
    ...
    <title>General Public List Printed By {{ $user->person->first_name.' '. $user->person->surname }}</title>
    ...
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <h3>General Public Search Result</h3>
                <br>
            </div>
            <!-- /.col -->
        </div>
                        ...
                        @if(count($publicsRegs) > 0)
                            @foreach($publicsRegs as $publicsReg)
                                <tr>
                                    ...
                                    <td>{{ !empty($publicsReg->names) ? $publicsReg->names : '' }}</td>
